...
def convert_ball2envmap(ball_dir, envmap_dir, ENV_MAP_HEIGHT=512):
    ...
    args.ball_dir = ball_dir
    args.envmap_dir = envmap_dir
    args.envmap_height = ENV_MAP_HEIGHT
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ball_dir", type=str, default="Path to chrome ball folder (square)")
    parser.add_argument("--envmap_dir", type=str, default="Path to envmap save folder (envmap)")
    args = parser.parse_args()
    convert_ball2envmap(args.ball_dir, args.envmap_dir)
