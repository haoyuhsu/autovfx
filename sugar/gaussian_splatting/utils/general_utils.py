...
# This implementation seems buggy (Please refer to: https://github.com/Asparagus15/GaussianShader/issues/19)
...
# # Adapted from GaussianPro (https://github.com/kcheng1021/GaussianPro/blob/main/gaussian_renderer/__init__.py)
# def get_minimum_axis(scales, rotations):
#     rotations_mat = build_rotation(rotations)
#     min_scales = torch.argmin(scales, dim=1)
#     indices = torch.arange(min_scales.shape[0])
#     minimum_axis = rotations_mat[indices, :, min_scales]
#     return minimum_axis
