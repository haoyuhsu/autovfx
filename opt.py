...
def get_opts():
    ...
    parser.add_argument("--scene_scale", default=1.0, type=float,
                        help="Scale of the scene in real-world meters")
    parser.add_argument("--downscale_factor", default=1, type=int,
                        help="Downscale factor for the scene (i.e., 1, 2, 4, 8)")
    ...
    parser.add_argument("--reference_image_path", default=None, type=str,
                        help="Path to the reference image for the scene")
    ...
    parser.add_argument("--blender_config_name", default="blender_cfg.json", type=str)
    parser.add_argument("--blender_output_dir_name", default="blend_results", type=str,
    ...
    parser.add_argument("--is_uv_mesh", action="store_true", default=False,
                        help="Enable this option if the scene mesh uses UV texturing")
    parser.add_argument("--emitter_mesh_path", default=None, type=str,
                        help="Path to the emitter mesh (.obj)")
    ...
    parser.add_argument("--deva_dino_threshold", default=0.7, type=float,
                        help="0.7 works best, 0.45 for some hard cases")
